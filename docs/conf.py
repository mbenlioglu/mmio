...
import sphinx_theme as theme

# -- Project information -----------------------------------------------------

project = 'libMMIO'
copyright = '2020, M.Mucahid Benlioglu'
author = 'M.Mucahid Benlioglu'
...
breathe_default_project = 'libMMIO'
...
latex_documents = [
    (master_doc, 'libMMIO.tex', 'libMMIO Documentation',
     'Georgia Tech - TDA Lab', 'manual'),
]
...
man_pages = [
    (master_doc, 'libMMIO', 'libMMIO Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'libMMIO', 'libMMIO Documentation',
     author, 'libMMIO', 'One line description of project.',
     'Miscellaneous'),
]
...
github_link = 'https://github.com/mbenlioglu/mmio/'
extlinks = {'source': (github_link + 'blob/master/%s', 'source '),
            'issue': (github_link + 'issues/%s', 'issue ')}
